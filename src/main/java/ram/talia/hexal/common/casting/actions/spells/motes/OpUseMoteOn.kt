...
object OpUseMoteOn : VarargSpellAction {
    ...
    override fun execute(
        ...
        if ((item.count != 1L) && (item.components != null))
        ...
        if (argc == 2) {
            ...
            return SpellAction.Result(
                ...
                Hexal.toMediaFromDust(HexalConfig.Server.USE_ITEM_ON_COST.get()),
    ...
    private data class EntityTargetSpell(val entity: Entity, val item: MoteIota) : RenderedSpell {
        override fun cast(env: CastingEnvironment) {
            ...
            item.components = PatchedDataComponentMap.fromPatch(item.item.components(), itemStack.componentsPatch);
